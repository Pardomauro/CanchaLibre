...
const GestionUsuarios = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Limpiar formulario
            setFormData({ nombre: '', email: '', celular: '', password: '', confirmPassword: '' });
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-3 rounded-lg text-sm font-semibold shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105 ${showCreateForm
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 pt-4">
                                <button
                                    type="submit"
                                    disabled={submitting}
                                    className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg text-sm font-semibold shadow-md transition-all duration-200 ${submitting
                        ...
                        <tr key={usuario.id_usuario} className="hover:bg-gradient-to-r hover:from-[#DAD7CD]/20 hover:to-[#A3B18A]/20 transition-colors duration-150">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold shadow-md transition-all duration-200 ${eliminando === usuario.id_usuario
